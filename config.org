...
(use-package exwm
  ...
  (require 'exwm-randr)
  (exwm-randr-enable)
  (add-hook 'exwm-randr-screen-change-hook #'kbd/update-displays)
...
(defun kbd/run-in-background (command)
  (let ((command-parts (split-string command "[ ]+")))
    (apply #'call-process `(,(car command-parts) nil 0 nil ,@(cdr command-parts)))))

(start-process-shell-command "feh" nil "feh --bg-scale ~/.wal.jpeg")
(start-process-shell-command "picom" nil "picom -b")
(start-process-shell-command "setxkbmap" nil "setxkbmap be")
